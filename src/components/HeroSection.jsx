...
function HeroSection() {
  const [text] = useTypewriter({
    words: ['Full Stack Developer', 'Research Enthusiast', 'Problem Solver', 'Open Source Contributor'],
    loop: true, // Loop indefinitely
    typeSpeed: 100, // Speed of typing
    deleteSpeed: 80, // Speed of deleting
    delaySpeed: 1000, // Pause time before deleting
  });
  const RESUME_PATH = '/Aashi_Garg_resume_updated.pdf'; 
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center p-8 lg:p-16 text-white relative overflow-hidden flex-1 bg-[#0d0f19] min-h-screen">
      ...
      <div className="flex-1 max-w-lg lg:pr-16 z-10 text-center lg:text-left">
        ...
        <h2 className="text-2xl lg:text-3xl font-semibold text-gray-200 mb-6">I am a <span className="text-2xl lg:text-3xl font-semibold text-[#fa3c68] mb-6 min-h-12">{ text }</span><Cursor cursorStyle='|' cursorColor='#fa3c68' /> {/* The blinking cursor */}
        </h2>
        ...
        <a 
            ...
            className="bg-[#fa3c68] hover:bg-[#d63158] text-white font-bold py-3 px-6 rounded-lg transition-colors inline-block" // Use inline-block to make the a tag act like a button
          >
            Check Resume
          </a>
        </div>
      ...
      <div className="relative w-72 h-72 lg:w-96 lg:h-96 mt-12 lg:mt-0 z-10">
        <div className="absolute inset-0 rounded-full opacity-20 blur-2xl animate-spin-slow"></div>
